                ...
                <div class="about span_1_of_2">
                    ...
                    <div class="about-top">
                        <div class="grid images_3_of_2">
                            <img src="<?php echo BASE_PATH ?> /assets/<?php echo $movie['image']; ?>" alt=""/>
                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-12 text-center" style="padding-bottom:20px">
                                    <?php if($date>$_SESSION['dd']){?><a href="booking.php?date=<?php echo date('d-m-Y',strtotime($date . "-1 days"));?>"><button class="btn btn-default"><i class="glyphicon glyphicon-chevron-left"></i></button></a> <?php } ?><span style="cursor:default" class="btn btn-default"><?php echo date('d-m-Y',strtotime($date));?></span>
                                    <?php if($date!=date('d-m-Y',strtotime($_SESSION['dd'] . "+4 days"))){?>
                                        <a href="booking.php?date=<?php echo date('d-m-Y',strtotime($date . "+1 days"));?>"><button class="btn btn-default"><i class="glyphicon glyphicon-chevron-right"></i></button></a>
                                    <?php }
